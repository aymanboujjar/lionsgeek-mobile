  ...
  return (
    ...
    >
      ...
      <View className="flex-1 mr-3">
        ...
        {user.status ? (
          <Text className="text-xs text-black/50 dark:text-white mt-0.5" numberOfLines={1}>
            {user.status}
          </Text>
        ) : user.promo ? (
          <Text className="text-xs text-black/50 dark:text-white mt-0.5">Promo {user.promo}</Text>
        ) : null}
      </View>
